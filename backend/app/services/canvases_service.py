...
def create_canvas_set(db: Session, series_id: int, name: str, description: Optional[str] = None, exchange_price: int = 50, sort_order: int = 0) -> CanvasSet:
    """
    新建画布商品套
    """
